...
import { getApi, previewCookie } from 'prismic-javascript';
...
import { ImgixFit, buildImgixUrl } from 'ts-imgix';
...
const PluginOptionsValidator = struct(Object.assign(Object.assign({}, baseSchema), { schemas: struct.record(['string', 'object']), shouldDownloadImage: 'function?', plugins: struct.size([0, 0]) }), Object.assign(Object.assign({}, baseDefaults), { shouldDownloadImage: () => () => false, plugins: [] }));
const BrowserOptionsValidator = struct(Object.assign(Object.assign({}, baseSchema), { pathResolver: 'function?', schemasDigest: 'string' }), baseDefaults);
...
const createClient = (repositoryName, accessToken) => __awaiter(void 0, void 0, void 0, function* () { return yield getApi(`https://${repositoryName}.prismic.io/api/v2`, { accessToken }); });
...
const buildURL = (url, params) => buildImgixUrl(url)(Object.assign(Object.assign({}, DEFAULT_PARAMS), params));
...
const normalizeLinkField = (apiId, field, _path, doc, env) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return new Proxy(Object.assign(Object.assign({}, field), { url: Link.url(field, linkResolverForField), document: linkedDocId, raw: field }), {
        get: (obj, prop) => {
            if (prop === 'document') {
...
const normalizeStructuredTextField = (apiId, field, _path, doc, env) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return {
        html: RichText.asHtml(field, linkResolverForField, htmlSerializerForField),
        text: RichText.asText(field),
        raw: field,
    };
});
const createEnvironment = (pluginOptions, typePaths) => {
    ...
    const createNodeId = (input) => v5(input, UUID_NAMESPACE);
...
const usePrismicPreview = (options) => {
    ...
    const asyncEffect = useCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c;
        if (!state.isPreview || !token || !documentId)
            return;
        set(previewCookie, token);
        const queryOptions = {};
...
export { buildFixedGatsbyImage, buildFluidGatsbyImage, mergePrismicPreviewData, usePrismicPreview };
